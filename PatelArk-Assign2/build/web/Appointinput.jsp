<%-- 
    Document   : Appointinput
    Created on : 4 Nov, 2019, 4:03:12 PM
    Author     : ARK PATEL
--%>
...
<html>
    ...
    <body>
        <center>
            ...
            <form class="form" action="AppointProcess" method="post">    
            <br>
            ...
            Appointment Time:<select name="timing">
            ...
            <a href="Appointentry.jsp">Back</a>
            <br>
            <br>
            </form>
        </center>
